...
simulated results demonstrate that our approach transfers to new
environments, significantly outperforming baseline methods that ground
language to actions.  For example, a typical task is to take a star block into
an orange painted room; one data instance for this task, collected
from an Amazon Mechanical Turk (AMT) user, is the command
...
also demonstrate that the same learned model that was trained on
simulated data can be transferred to a physical robot with a different 
